...
/* eslint-disable no-shadow */ /* eslint-disable no-console */ "use strict";
...
if (game.getStatus() === "lose") document.querySelector(".message-lose").classList.remove("hidden");
...
function render() {
    ...
    for(let i = 0; i <= 3; i++)for(let j = 0; j <= 3; j++){
        ...
        cell.className = cell.textContent === "" ? "field-cell" : "field-cell field-cell--" + state[i][j];
    }
    // Скрываем/показываем сообщения
    document.querySelector(".message-start").classList.add("hidden");
    if (game.getStatus() === "win") document.querySelector(".message-win").classList.remove("hidden");
    else document.querySelector(".message-win").classList.add("hidden");
    if (game.getStatus() === "lose") document.querySelector(".message-lose").classList.remove("hidden");
    else document.querySelector(".message-lose").classList.add("hidden");
}
